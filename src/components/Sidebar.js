...
const Sidebar = () => {
    const handleEmailMe = () => {
        window.open("mailto:ullasbc0.com")
    }
    ...
    return (
        ...
        >
            <img src={images} alt="avatar" className="sidebar__avatar" />
            <div className="sidebar__name">Ullas <span>BC</span> </div>
            ...
            <div className="sidebar__contact">
                <div className="sidebar__item sidebar__github">
                    <a href="https://github.com/UllasBC/"><img src={github} alt="github" className="sidebar__icon mr-3" />github</a>
                </div>
